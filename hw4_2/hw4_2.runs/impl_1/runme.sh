...
HD_PWD='D:/DrexelStudy/ECE302/hw4_2/hw4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_mux.tcl -notrace
