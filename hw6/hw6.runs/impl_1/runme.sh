...
HD_PWD='D:/DrexelStudy/ECE302/hw6/hw6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twosCarray.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twosCarray.tcl -notrace
