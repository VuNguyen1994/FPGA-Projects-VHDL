...
HD_PWD='D:/DrexelStudy/ECE302/hw6/hw6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twosCarray.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twosCarray.tcl
