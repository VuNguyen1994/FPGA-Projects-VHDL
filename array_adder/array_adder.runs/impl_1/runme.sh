...
HD_PWD='D:/DrexelStudy/ECE302/array_adder/array_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_adderr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_adderr.tcl -notrace
