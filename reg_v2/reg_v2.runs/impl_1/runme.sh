...
HD_PWD='D:/DrexelStudy/ECE302/reg_v2/reg_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_v2.tcl -notrace
