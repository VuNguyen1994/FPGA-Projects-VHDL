...
HD_PWD='D:/DrexelStudy/ECE302/BCD_ArrayAdd/BCD_ArrayAdd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_array_adder_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_array_adder_tb.tcl -notrace
