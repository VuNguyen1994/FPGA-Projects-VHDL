...
HD_PWD='D:/Drexel Study/ECE302/hw2/hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_00_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_00_tb.tcl -notrace
