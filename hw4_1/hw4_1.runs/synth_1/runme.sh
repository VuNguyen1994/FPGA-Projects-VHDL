...
HD_PWD='D:/DrexelStudy/ECE302/hw4_1/hw4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_or_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_or_gate.tcl
