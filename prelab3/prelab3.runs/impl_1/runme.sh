...
HD_PWD='D:/Drexel Study/ECE302/prelab3/prelab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_serial_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_serial_adder.tcl -notrace
