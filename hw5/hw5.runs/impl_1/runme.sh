...
HD_PWD='D:/DrexelStudy/ECE302/hw5/hw5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twos_C_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twos_C_system.tcl -notrace
