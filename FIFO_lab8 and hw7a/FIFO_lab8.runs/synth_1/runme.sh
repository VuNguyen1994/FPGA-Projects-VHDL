...
HD_PWD='D:/DrexelStudy/ECE302/FIFO_lab8/FIFO_lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo4x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo4x16.tcl
