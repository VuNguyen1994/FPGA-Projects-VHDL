...
HD_PWD='D:/DrexelStudy/ECE302/hw4_3/hw4_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_t_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_t_gate.tcl -notrace
