...
HD_PWD='D:/Drexel Study/ECE302/lab2/prelab2/prelab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register4b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register4b.tcl -notrace
