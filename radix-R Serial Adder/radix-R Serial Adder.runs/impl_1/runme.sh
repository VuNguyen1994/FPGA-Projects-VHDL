...
HD_PWD='D:/DrexelStudy/ECE302/radix-R Serial Adder/radix-R Serial Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log radix5_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source radix5_adder.tcl -notrace
