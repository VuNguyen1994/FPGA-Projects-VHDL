...
HD_PWD='D:/Drexel Study/ECE302/lab2/prelab2/prelab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register4b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register4b.tcl
