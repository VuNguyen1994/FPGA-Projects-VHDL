...
HD_PWD='D:/DrexelStudy/ECE302/reg_v1/reg_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_v1.tcl -notrace
