...
HD_PWD='D:/DrexelStudy/ECE302/hw4_3/hw4_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_t_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_t_gate.tcl
