...
HD_PWD='D:/DrexelStudy/ECE302/reg_v3/reg_v3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_v3.tcl -notrace
