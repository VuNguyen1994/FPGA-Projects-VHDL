...
HD_PWD='D:/Drexel Study/ECE302/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log step_cascade_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source step_cascade_register.tcl
