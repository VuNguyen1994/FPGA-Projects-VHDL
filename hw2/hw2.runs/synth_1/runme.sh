...
HD_PWD='D:/Drexel Study/ECE302/hw2/hw2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_00_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_00_tb.tcl
