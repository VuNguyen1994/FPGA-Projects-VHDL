...
HD_PWD='D:/Drexel Study/ECE302/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_adder.tcl -notrace
