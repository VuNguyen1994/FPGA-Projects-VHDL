...
HD_PWD='D:/DrexelStudy/ECE302/hw4_2/hw4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_mux.tcl
