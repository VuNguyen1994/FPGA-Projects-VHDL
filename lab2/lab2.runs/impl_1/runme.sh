...
HD_PWD='D:/Drexel Study/ECE302/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log step_cascade_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source step_cascade_register.tcl -notrace
