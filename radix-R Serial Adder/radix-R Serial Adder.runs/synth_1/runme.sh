...
HD_PWD='D:/DrexelStudy/ECE302/radix-R Serial Adder/radix-R Serial Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log radix5_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source radix5_adder.tcl
