...
HD_PWD='D:/DrexelStudy/ECE302/array_adder/array_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_adderr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_adderr.tcl
