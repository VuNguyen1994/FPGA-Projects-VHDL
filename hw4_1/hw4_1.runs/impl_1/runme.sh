...
HD_PWD='D:/DrexelStudy/ECE302/hw4_1/hw4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_or_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_or_gate.tcl -notrace
