...
HD_PWD='D:/DrexelStudy/ECE302/reg_v2/reg_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_v2.tcl
