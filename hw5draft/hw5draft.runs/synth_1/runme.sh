...
HD_PWD='D:/DrexelStudy/ECE302/hw5draft/hw5draft.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twos_C_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twos_C_system.tcl
