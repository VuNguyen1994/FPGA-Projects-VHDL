...
HD_PWD='D:/DrexelStudy/ECE302/BCD_ArrayAdd/BCD_ArrayAdd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_array_adder_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_array_adder_tb.tcl
