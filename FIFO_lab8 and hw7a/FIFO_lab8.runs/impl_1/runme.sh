...
HD_PWD='D:/DrexelStudy/ECE302/FIFO_lab8/FIFO_lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo4x16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo4x16.tcl -notrace
