...
HD_PWD='D:/Drexel Study/ECE302/prelab3/prelab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_serial_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_serial_adder.tcl
